...
<div class="app-container">
  ...
  <div class="main-area">
      ...
      <div class="access-links">
        <div class="access-link-wrapper">
          ...
          <div class="access-icon">
			<svg xmlns="http://www.w3.org/2000/svg" width="55" height="55" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-6 h-6" color="black">
      ...
      <div class="content-section-line">
        <div class="section-part left">
          <a class="image-wrapper">
            ...
            <img src="https://th.bing.com/th/id/OIP.YNHKIZtfAynlcatnNRz6FAHaE8?w=250&h=187&c=7&r=0&o=5&pid=1.7"/>
          </a>
        </div>
    ...
    <br>
    <br>
    	<Marquee behavior=left scrollamount=left>Welcome to Travel_Planner!! Enjoy your trip with Travel_Planner!! Thankyou.</Marquee>
    </footer>
  </div>
  <div class="right-area">
  <div id="wrqp">
    <h1 class="member" style="text-align: center;">Member<br>Login</h1>
    <hr>
    <div class="form">
    <div class="form2">
     <div class="form3">
		<form action="login.do" method="post" name="frm">
					<label for="userId">아이디</label><input placeholder="UserId" type="text" name="userId">
					<br>
					<label for="userPwd">비밀번호</label><input placeholder="Password" type="password" name="userPwd">
					<br>
					<!-- <label style="font-size: 1vw;"><input type="checkbox">아이디저장</label>
       				<label style="font-size: 1vw;"><input type="checkbox">보안접속</label> -->
       				<br>
					<label style="text-align: center"><input type="submit" value="로그인" onclick="returecn chkLogin()"></label>
					<label style="text-align: center"><input type="reset" value="취소"></label>
					<label style="text-align: center"><input type="button" value="회원가입" onclick="location.href='member/join_before.jsp'"></label>
		</form>	
	</div>
	</div>
	</div>
