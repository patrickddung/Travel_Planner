  ...
  <head>
    ...
    <script>
      ...
      process.env.GOOGLE_MAPS_API_KEY =
        "AIzaSyDjtW34Ax16khc7UYth6--V4pNFX1XlHUE";
    </script>
    <style>
    	#map {
  height: 100%;
  ...
  <body>
    ...
    class PuzzleDemo {
        ...
        startClock_() {
            ...
            const timeDiv = this.timeDiv_;
            if (timeDiv)
                timeDiv.textContent = "0.0 seconds";
            const t = new Date();
        ...
        boundsContainsPoly_(bounds, poly) {
            const b = new google.maps.LatLngBounds(new google.maps.LatLng(bounds[0][0], bounds[0][1]), new google.maps.LatLng(bounds[1][0], bounds[1][1]));
